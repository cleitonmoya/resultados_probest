...
\renewcommand{\v}[1]{\bm{#1}}  	    			% vetor (fixo ou aleatório) - negrito, itálico
\newcommand{\m}[1]{\mathbf{#1}}					% matriz - negrito, fonte não itálica
\newcommand{\rv}[1]{#1}             			% variável aleatória (não usada no momento)
...
% ---------- Determinante (notação de barras, como nos slides) ----------
\DeclarePairedDelimiter\deter{\lvert}{\rvert}   % determinante em notação de barras
